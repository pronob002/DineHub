...
class _DateSelectionPageState extends State<DateSelectionPage> {
  DateTime? selectedDate; // Change late DateTime to DateTime?
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 20),
                buildItemRow('', doc['Item1'], doc['PriceItem1']),
                buildItemRow('', doc['Item2'], doc['PriceItem2']),
                buildItemRow('', doc['Item3'], doc['PriceItem3']),
                buildItemRow('', doc['Item4'], doc['PriceItem4']),
                buildItemRow('', 'Others', doc['Others(Spices)']),
              ],
            ),
          ),
          SizedBox(height: 20),
